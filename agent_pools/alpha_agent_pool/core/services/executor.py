...
class Executor:
    ...
    This minimal version assumes single-threaded async execution with
    simple backoff on failures.
    """

    def __init__(self, feature_port: FeaturePort, strategy_port: StrategyPort, memory_port: MemoryPort | None = None):
    ...
    async def run(self, plan: AlphaPlan) -> AlphaResult:
        ...
        for node in plan.nodes:
            ...
            try:
                ...
                # basic backoff: wait short and continue; real implementation would obey policy
